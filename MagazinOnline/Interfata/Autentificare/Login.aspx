<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="MagazinOnline.Interfata.Autentificare.Login" %>
                                ...
                                <div class="p-5">
                                    ...
                                    <form id="form1" runat="server" class="user">
                                        <div class="form-group">
                                            <asp:TextBox runat="server" ID="userName" CssClass="form-control form-control-user" placeholder="Utilizator"></asp:TextBox>
                                        </div>
                                        <div class="form-group">
                                            <asp:TextBox runat="server" id="parola" CssClass="form-control form-control-user" TextMode="Password"  placeholder="Password"/>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <asp:Button runat="server" Text="Login" CssClass="btn btn-primary btn-user btn-block" />
